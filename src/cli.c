...
static char doc[] =
"fastFM -- Provides a range of solvers and loss functions for the FACTORICATION MACHINE model.";
...
static struct argp_option options[] = {
    {"rng-seed",  556, "NUM",      0,  "Seed for random number generator (default current time(NULL))" },
    {"task",  't', "S",      0,  "The tasks: 'classification', 'regression' or 'ranking' are supported (default 'regression'). Ranking uses the Bayesian Pairwise Ranking (BPR) loss and needs an additional file (see '--train-pairs')" },
    {"train-pairs",  555, "FILE",      0,  "Ranking only! Required training pairs for bpr training."},
    { 0, 0, 0, 0, "Solver:", 1},
    {"solver",  's', "S",      0,  "The solvers: 'als', 'mcmc' and 'sgd' are available for 'regression' and 'classification (default 'mcmc'). Ranking is only supported by 'sgd'." },
    {"n-iter",  'n', "NUM",      0,  "Number of iterations (default 50)" },
    {"step-size",  444, "NUM",      0,  "Step-size for 'sgd' updates (default 0.01)" },
    {"init-var",  'i', "NUM",      0,  "N(0, var) is used to initialize the coefficients of matrix V (default 0.1)" },
    { 0, 0, 0, 0, "Model Complexity and Regularization:", 3},
    {"rank",  'k', "NUM",      0,  "Rank of the factorization, Matrix V (default 8)." },
    {"l2-reg",  'r', "NUM",      0,  "l2 regularization, set equal penalty for all coefficients (default 1)" },
    {"l2-reg-w",  222, "NUM",      0,  "l2 regularization for the linear coefficients (w)" },
    {"l2-reg-V",  333, "NUM",      0,  "l2 regularization for the latent representation (V) of the pairwise coefficients" },
